...
const createCurrentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingUser = yield user_1.default.findOne({ auth0Id }); // Finds user with auth0 id from database
        if (existingUser) {
            return res.status(200).send();
        }
        const newUser = new user_1.default(req.body);
        yield newUser.save(); // creating new user in db
...
exports.default = MyUserController;
